...
public class UrlGenerator {
	...
	public String getURLBase() {
		...
		try {
			...
			base_url = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
	...
	public String getNGINXFilesBasePath() {
		...
		try {
			...
			if ("10.203.10.158".equals(ip_address) || "115.124.125.227".equals(ip_address)
					|| "pmis.mrvc.gov.in".equals(ip_address)) {
