...
import com.wcr.wcrbackend.reference.Idao.UtilityTypeDao;
...
public class UtilityTypeDaoImpl implements UtilityTypeDao{
	...
	private List<Safety> getTablesList(Safety obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='utility_type' and s.name='dbo'\r\n" + 
	...
	public boolean updateUtilityType(Safety obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table utility_type NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table utility_type CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
