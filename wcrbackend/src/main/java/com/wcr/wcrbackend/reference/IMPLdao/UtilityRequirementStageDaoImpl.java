...
import com.wcr.wcrbackend.reference.Idao.UtilityRequirementStageDao;
...
public class UtilityRequirementStageDaoImpl implements UtilityRequirementStageDao{
	...
	private List<Safety> getTablesList(Safety obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='utility_requirement_stage' and s.name='dbo'\r\n" + 
	...
	public boolean updateUtilityRequirementStage(Safety obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table utility_requirement_stage NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table utility_requirement_stage CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
