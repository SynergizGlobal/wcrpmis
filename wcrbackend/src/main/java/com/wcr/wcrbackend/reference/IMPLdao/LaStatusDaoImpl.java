...
@Repository
public class LaStatusDaoImpl implements LaStatusDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='la_status' and s.name='dbo'\r\n" + 
	...
	public boolean updatelandAcquisitionStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table la_status NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table la_status CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
	...
	public boolean deletelandAcquisitionStatus(TrainingType obj) throws Exception {
		...
		try {
			...
			String deleteQry ="DELETE from la_status WHERE status= :status; ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
