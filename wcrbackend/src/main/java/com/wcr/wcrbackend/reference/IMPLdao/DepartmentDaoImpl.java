...
public class DepartmentDaoImpl implements DepartmentDao{
	...
	public List<TrainingType> getDepartmentsList() throws Exception {
		...
		try {
			String qry ="select department, department_name, contract_id_code from department ";
	...
	public boolean addDepartment(TrainingType obj) throws Exception {
		...
		try {
			...
			String insertQry = "INSERT INTO department"
					+ "( department, department_name, contract_id_code) VALUES (:department, :department_name, :contract_id_code)";
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='department' and s.name='dbo'\r\n" + 
	...
	public boolean deleteDepartment(TrainingType obj) throws Exception {
		...
		try {
			...
			String deleteQry ="DELETE FROM department WHERE department= :department; ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
