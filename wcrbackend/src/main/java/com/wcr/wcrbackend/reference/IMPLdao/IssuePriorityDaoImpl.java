...
import com.wcr.wcrbackend.reference.Idao.IssuePriorityDao;
...
public class IssuePriorityDaoImpl implements IssuePriorityDao{
	...
	private List<TrainingType> getTablesList(TrainingType obj) throws Exception {
		...
		try {
			String qry = "select  object_name(fkx.fkeyid) as tName,\r\n" + 
					...
					"where object_name(fkx.rkeyid)='issue_priority' and s.name='dbo'\r\n" + 
	...
	public boolean updateIssuePriority(TrainingType obj) throws Exception {
		...
		try {
			...
			String disableQry = "Alter Table issue_priority NOCHECK Constraint All ";
			BeanPropertySqlParameterSource paramSource = new BeanPropertySqlParameterSource(obj);		 
			...
			String  enableQry =	"Alter Table issue_priority CHECK Constraint All";
			paramSource = new BeanPropertySqlParameterSource(obj);	
