package com.wcr.wcrbackend.constants;
...
public class PageConstants {
	...
	public static final String detailsOfContracts = "forms/detailsOfContracts";
	...
	public static final String safetyEquipmentGrid = "forms/safetyEquipmentGrid";
	public static final String addEditSafetyEquipment = "forms/addEditSafetyEquipment";
	
	public static final String budgetGrid = "forms/budgetGrid";
	public static final String addEditBudget = "forms/addEditBudget";
	public static final String addPaymentDetails = "forms/addPaymentDetails";
	...
	public static final String FinanceReport="/forms/financeReport";
	...
	public static final String utilityReport = "forms/utilityReport";
	...
	public static final String division = "referenceForms/division";
	public static final String section = "referenceForms/section";
	...
	public static final String projectType = "referenceForms/projectType";  
	...
	public static final String rrExecutives = "referenceForms/rrExecutives";
	
	public static final String landExecutives = "referenceForms/landExecutives";
