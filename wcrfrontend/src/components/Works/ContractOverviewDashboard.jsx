...
export default function ContractnOverviewDashboard() {
  ...
  // -------- LOAD DEFAULT PAGE ----------
  useEffect(() => {
    navigateToPage(menuItems[1].path, menuItems[1].label,menuItems[1].urllink);
    ...
    <>
      ...
      <div className={styles.container}>
        <div style={{ marginTop: "20px", height: "80vh", position: "relative" }}>
		  ...
		  {iframeSrc && (
		    <iframe
		      title="Contract Overview Dashboard"
		      src={`${iframeSrc}`}
		      style={{
		        marginTop: "25px",
		        width: "100%",
