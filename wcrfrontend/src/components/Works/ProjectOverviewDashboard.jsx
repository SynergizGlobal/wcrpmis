  ...
  const buildTrustedUrl = async (tableauPath) => {
    try {
      const res = await fetch(`${API_BASE_URL}/tableau/ticket`, {
        ...
        body: new URLSearchParams({ username: "SynTrack", client_ip: "10.48.192.7" }),
      });
