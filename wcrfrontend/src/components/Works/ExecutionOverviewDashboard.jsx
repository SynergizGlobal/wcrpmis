...
export default function ExecutionOverviewDashboard() {
  ...
  // -------- LOAD DEFAULT PAGE ----------
  useEffect(() => {
    navigateToPage(menuItems[0].path, menuItems[0].label,menuItems[0].urllink);
    ...
    <>
      ...
      <div className={styles.container}>
        <div style={{ marginTop: "20px", height: "80vh", position: "relative" }}>
		  ...
		  {iframeSrc && (
		    <iframe
		      title="Execution Overview Dashboard"
		      src={`${iframeSrc}`}
		      style={{
		        marginTop: "25px",
		        width: "100%",
